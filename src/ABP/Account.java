...
{
    /**
     * Sum of funds belonging to bank and portfolio.
     *
     * @see Balance
     */
     ...
     */
    private static LinkedList<Transaction> transactionHistory = new LinkedList<>();
     ...
     *
     * @param name          Name designated to the account.
     * @param initialAmount Total funds in the account that is located in either the bank, portfolio, or both.
     * @param bank          Bank associated with account. Holds funds not used for trading assets.
     ...
     */
    private Account(String name, Balance initialAmount, Bank bank, ArrayList<User> users, Portfolio port)
    {
        accountName = name;
        ...
        //TODO Create Admin user -- needs random password generation (Connor)
    }
    ...
    /**
     * Creates an account with only a name, and an empty balance, bank, and portfolio, and no users.
     * Not recommended to use if it is important to have names associated with the bank and portfolio.
     *
     * @param accName Name of the account.
     */
    private Account(String accName)
    {
        this(accName, new Balance(), new Bank(), new ArrayList<>(), new Portfolio());
    }
    
    /**
     * Creates an account with the default name "Unnamed Account," an empty balance, bank, and portfolio, and no users.
     */
    public Account()
    {
        this("Unnamed Account");
    }
    
    /**
     * Contains all current and historical values and associated transactions with the account.
    ...
    /**
     * A list of transactions that have been requested and awaiting resolution.
    ...
    /**
     * A list of all transactions processed within the account. Transactions that are cancelled before resolution
     * are not included in the history.
     * @return History of all transactions requested and resolved.
     */
    public static LinkedList<Transaction> getTransactionHistory()
    {
        return transactionHistory;
    }
    
    /**
     * A list of all users existing in the account.
     * @return All users
     * @see LucaMember
     */
    ...
    /**
     * The name designated to the account at the time of creation.
    ...
    /**
     * The time and date information as to when the account was created.
