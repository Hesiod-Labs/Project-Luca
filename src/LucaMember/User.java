...
{
    /**
     * Initials of first, middle, and last initials, plus three numbers randomly generated by
    ...
    /**
     * Determines which user actions are allowed.
     * @see UserType
     */
    private UserType clearance;
    
    /**
     * Aligns with the available sectors associated with an asset ({@link Asset.Sector}).
     */
    ...
    public User(String first, String middleInit, String last, String password, String w1, String w2, String w3,
                UserType role, double contribution, UserSector... sectors)
    {
...
//        Account.getAccountBalance().updateBalance( new Balance(contribution));
    ...
    public void contribute(double amount) throws IOException
    {
        ...
        this.requestTransaction(new Transaction(Transaction.Type.DEPOSIT, amount));
    }
